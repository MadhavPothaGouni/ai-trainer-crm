    ...
    private boolean isCoreCrmResource(Permission.Resource resource) {
        return switch (resource) {
            case LEAD, CONTACT, ACCOUNT, OPPORTUNITY, ACTIVITY, QUOTE, TICKET, EMAIL_MESSAGE, CALENDAR_EVENT, ATTACHMENT, APPROVAL_REQUEST,
                    ...
                    SHIFT, REFERRAL, PURCHASE_ORDER, CLIENT_DOCUMENT,
                    TIME_OFF_REQUEST, LOCKER_ASSIGNMENT, PROMO_REDEMPTION, CLIENT_CHECK_IN,
                    ROOM_BOOKING, GIFT_CARD, PROGRESS_PHOTO, EQUIPMENT_RESERVATION, COMPENSATION_RECORD,
                    NO_SHOW_RECORD, LOYALTY_TRANSACTION, INTAKE_FORM_SUBMISSION,
                    CLASS_WAITLIST, MEMBERSHIP_FREEZE, NUTRITION_LOG, PERSONAL_RECORD, REFUND_RECORD, CLIENT_FEEDBACK -> true;
            default -> false;
        };
    }
