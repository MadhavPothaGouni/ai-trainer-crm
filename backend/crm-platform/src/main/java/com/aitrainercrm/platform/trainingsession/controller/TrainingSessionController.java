...
public class TrainingSessionController {
    ...
    public ApiResponse<TrainingSessionDto> get(@PathVariable UUID trainingSessionId, @AuthenticationPrincipal UserPrincipal principal) {
        return ApiResponse.ok(TrainingSessionDto.from(trainingSessionService.get(principal, trainingSessionId)));
    }
    ...
    public ApiResponse<TrainingSessionDto> update(
        ...
        return ApiResponse.ok(TrainingSessionDto.from(trainingSessionService.update(principal, trainingSessionId, request)), "Training session updated");
    }
