...
public class Permission extends BaseEntity {
    ...
    public enum Resource {
        ...
        ATTACHMENT, APPROVAL_REQUEST, SLA_POLICY, TERRITORY_RULE, LEAD_SCORING_RULE, SALES_GOAL,
        EMAIL_TEMPLATE, REGION, COMMISSION_PLAN, COMMISSION_RECORD, DATA_SUBJECT_REQUEST,
        COURSE, COURSE_ENROLLMENT, CERTIFICATION, USER_CERTIFICATION, SEQUENCE, SEQUENCE_ENROLLMENT,
        BOOKING_LINK, MACRO, CONTRACT, CLIENT_GOAL, TRAINING_SESSION, EXERCISE, NUTRITION_PLAN, BODY_MEASUREMENT,
        MEMBERSHIP_PLAN, MEMBERSHIP, GROUP_CLASS, CLASS_SESSION, CLASS_ATTENDANCE, EQUIPMENT, MAINTENANCE_LOG,
        SHIFT_TEMPLATE, SHIFT, REFERRAL, VENDOR, PURCHASE_ORDER, CLIENT_DOCUMENT,
        TIME_OFF_REQUEST, LOCKER, LOCKER_ASSIGNMENT, PROMO_CODE, PROMO_REDEMPTION, CLIENT_CHECK_IN,
        ROOM, ROOM_BOOKING, GIFT_CARD, PROGRESS_PHOTO, EQUIPMENT_RESERVATION, COMPENSATION_RECORD,
        NO_SHOW_RECORD, LOYALTY_TRANSACTION, INTAKE_FORM, INTAKE_FORM_SUBMISSION,
        CLASS_WAITLIST, MEMBERSHIP_FREEZE, NUTRITION_LOG, PERSONAL_RECORD, REFUND_RECORD, CLIENT_FEEDBACK
    }
