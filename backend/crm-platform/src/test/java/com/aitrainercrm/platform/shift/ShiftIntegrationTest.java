...
class ShiftIntegrationTest extends AbstractIntegrationTest {
    ...
    void shiftTemplateCatalogAndShiftLifecycle_endToEnd() throws Exception {
        ...
        assertThat(Instant.parse(readField(clockOutResult, "data", "clockInAt")))
                .isCloseTo(Instant.parse(clockInAt), org.assertj.core.api.Assertions.within(1, java.time.temporal.ChronoUnit.MICROS));
