...
const CRM_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/refund-records", label: "Refund Records" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/client-feedback", label: "Client Feedback" },
      ...
      { to: "/membership-freezes", label: "Membership Freezes" },
      { to: "/group-classes", label: "Group Classes" },
      { to: "/class-sessions", label: "Class Sessions" },
      { to: "/class-waitlists", label: "Class Waitlists" },
